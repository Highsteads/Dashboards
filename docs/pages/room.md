...
**Cameras.** Any camera whose entry names this room, as a still that cross-fades every three seconds, fetched only when the picture has changed. Tap it and the Cameras page opens with that camera live at the top.
