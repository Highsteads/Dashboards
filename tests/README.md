...
| `test_heating_boost_pin.mjs` | The Heating page's boost and force buttons go through the PIN |
...
| `test_room_camera_keyboard.mjs` | A room page's camera card works from the keyboard (3.46.0). |
